...
{
    //public class DapperMethod<TEntity> : IDapperMethod<TEntity>
    //    where TEntity : class
    //{
    //    //private readonly ISupDbConnetion _supDbConnetion;

    //    //public DapperMethod(ISupDbConnetion supDbConnetion)
    //    //{
    //    //    _supDbConnetion = supDbConnetion;
    //    //}
